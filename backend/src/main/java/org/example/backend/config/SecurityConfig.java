...
public class SecurityConfig {
    ...
    // SecurityFilterChain
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, SecurityFilterChain oauth2SecurityFilterChain)
            throws Exception {
        ...
        // Oauth2 인증용
        http
                .oauth2Login(oauth2 -> oauth2.successHandler(socialSuccessHandler)); // 여기서
